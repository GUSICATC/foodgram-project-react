    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.FloatField(blank=True, default=0, max_length=5, verbose_name='количество')),
                ('measurement_unit', models.CharField(blank=True, choices=[('KG', 'кг'), ('GR', 'гр.'), ('ML', 'мл')], max_length=200, verbose_name='единица измерения')),
            ],
            options={
